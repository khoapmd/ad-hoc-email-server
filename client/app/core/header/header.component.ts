...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer, private router: Router, public deviceService: DeviceService) {
    iconRegistry.addSvgIcon(
      'dtes-logo',
      sanitizer.bypassSecurityTrustResourceUrl('assets/svg/dtes-bluish.svg'));
    iconRegistry.addSvgIcon(
      'dtes-logo-text',
      sanitizer.bypassSecurityTrustResourceUrl('assets/svg/dtes-sm-side-text.svg'));
