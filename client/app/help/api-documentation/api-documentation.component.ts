...
export class ApiDocumentationComponent implements OnInit {
  h1 = 'ooTech DTES - Disposable Temporary Email Service API Documentation';
  h2 = '';
  ...
  constructor(seoService: SeoService) {
    seoService.setTitle('ooTech DTES - API Documentation');
    seoService.updateMetaTag({name: 'description', content: 'ooTech DTES - Disposable Temporary Email Service - API Documentation. '});
  }
